 ...
 *
 * Descripcion:
 * 	Registro de dentistas. Primero se validan los datos introducidos por el usuario.DespuÈs se verifica
 *  la unicidad del usuario, si es ˙nico se registra primero consultorio, despuÈs direcciÛn, finalmente
 *  dentista. Se envÌa un correo de registro al sistema. 
 *
 */
						...
						<ul>
							<li>
								...
								<form action="regAdminDent.php" method="post" onsubmit="return validate(this)">
									...
									<input type="text" value="<?php echo $cedula;?>" name="cedula" alt="*C√©dula:" title="Introduce tu cedula profesional" id="cedula" /> 
