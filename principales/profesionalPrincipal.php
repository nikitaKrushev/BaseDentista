 ...
 *
 * Descripcion:
 * 	P�gina principal del due�o del sitio.
 *
 */
...
<body id="home"><!-- #home || #page-post || #blog || #portfolio -->
    ...
    <div id="page">
        ...
        <div id="left-col">
            ...
            <!-- Logo -->
            <a href="profesionalPrincipal.php" id="logo">Foundation</a>
            
            <!-- Main Naigation (active - .act) -->
            <div id="main-nav">
                <ul>
                    <li class="act"><a href="profesionalPrincipal.php">Inicio</a></li>
                    ...
                    <li> <a href="../consulta/directorioConsultoriosProfesionalSalud.php">Consultar directorio de consultorios</a> </li>
                	</ul>
            </div>
            
            <!-- News Widget -->
            <div class="widget w-news">
                <h4 class="w-title title-light">Cerrar sesión.</h4>
                <div class="w-content">
                    <ul>
                        <li>
