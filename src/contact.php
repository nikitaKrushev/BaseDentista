<?php
$emailTo = 'arias.anayara@uabc.edu.mx'; //Put your own email address here
    ...
    <div id="page">
        ...
        <div id="wrap">
            <div id="main-col">
                ...
                <a href="#" id="share" rel="prettySociable" title="Drag to Share"><img src="img/share.png" alt="" /></a>
        ...
        <div id="left-col">
            ...
            <!-- Logo -->
            <a href="index.html" id="logo"><img src="img/logo.png" alt="Foundation" /></a>
        ...
        <div id="footer">
            ...
            <div id="f-main-col">
                ...
                <div class="widget w-50 w-text last" id="text-1">
                    ...
                    <div class="w-content">
                        <a href="#"><img src="img/pictures/office.jpg" alt="Our Building" class="alignright" /></a>
