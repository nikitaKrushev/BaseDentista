...
$cuadrante4Len = count($dientesPresentes); //Cuantos dientes hay en el cuadrante 1
$strCuad4 = substr_replace($strCuad4 ,"",-1);;

//Ahora a crear el arreglo nXm que contendra cada estado de los dientes en cada revision
