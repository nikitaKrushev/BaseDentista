...
<html>
    ...
    <div id="page">
            ...
            <div id="main-col"><!-- Nivo Slider -->
                ...
                <div id="revisa" class="divisionDetalles">                                            					                       
					<div id="revisaForm" style="color:#0000FF">			
						<form action="directorioConsultoriosProfesionalSalud.php" method="post">
							<input type="text"  name="nombre" alt="Texto:" title="" id="nombre" /><br>  					
        ...
        <div id="left-col">
        	...
        	<!-- Logo -->
            <a href="../principales/profesionalPrincipal.php" id="logo">Inicio</a>
