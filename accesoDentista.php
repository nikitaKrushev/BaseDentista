 ...
 * 
 * Descripcion:
 * 	Realiza un filtro dependiendo de la sesiÛn del usuario. Si no esta registrado el usuario, se
...
if (!$row) {
	error('Un error ocurri√≥ mientras revisabamos sus'.
...
<body>
	...
	<p>
		El usuario o contrase√±a son incorrectos, o no eres un usuario
		registrado en esete sito. Intenta acceder de nuevo al sistema, has
		click <a href="http://cartillabucaldigital.org/index.php">aqu√≠.
	</p>
</body>
</html>
<?php
